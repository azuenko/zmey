...
func (f *Forwarder) CallbackSend(sendF func(to int, payload interface{})) {
	f.sendF = sendF
}
func (f *Forwarder) CallbackReturn(returnF func(payload interface{})) {
	f.returnF = returnF
}
func (f *Forwarder) CallbackTrace(traceF func(payload interface{})) {
	f.traceF = traceF
}
func (f *Forwarder) CallbackError(errorF func(error)) {
	f.errorF = errorF
}
