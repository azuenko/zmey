...
func (c *Client) CallbackSend(sendF func(to int, payload interface{})) {
	c.sendF = sendF
}
func (c *Client) CallbackReturn(returnF func(payload interface{})) {
	c.returnF = returnF
}
func (c *Client) CallbackTrace(traceF func(payload interface{})) {
	c.traceF = traceF
}
func (c *Client) CallbackError(errorF func(error)) {
	c.errorF = errorF
}
